...
DATASET_ANNOTATIONS_PATH = "/mnt/gpid08/users/eric.presas/annotations_NSOD"
if __name__ == "__main__":
    edge_boxes_generator = GenerateEdgeBoxes(path_dataset=DATASET_IMAGES_PATH, path_annotations=DATASET_ANNOTATIONS_PATH)

    edge_boxes_generator.process_stage(stage='train', max_images=2000)
    edge_boxes_generator.process_stage(stage='val', max_images=500)
